...
class messages extends CI_Controller
{
    ...
    public function compose()
    {
        if (isset($this->USER_OBJ->id)) {
            ...
            $this->load->view('email-compose', $compose_data);
        } else {
            redirect('/');
        }
    }
...
//        }
    ...
    public function inbox()
    {
        if (isset($this->USER_OBJ->id)) {
            ...
            $this->load->view('email-list', $inbox_data);
        } else {
            redirect('/');
        }
    }
    ...
    public function mail_detail($message_id, $sent = false)
    {
        ...
        $this->load->model('user');
        $from_user = $this->user->get_user($message->from);
        $this->load->view('email-opened', array('message' => $message, 'from_user' => $from_user));
    }
    ...
    public function sentbox()
    {
        if (isset($this->USER_OBJ->id)) {
            ...
            $this->load->view('email-list-sent', $sentbox_data);
        } else {
            redirect('/');
        }
    }
