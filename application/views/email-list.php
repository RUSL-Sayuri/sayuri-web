<table id="inbox-table" class="table table-striped table-hover">
    ...
    <?php foreach ($inbox_messages as $message):
        ...
        ?>
        <tr id="<?= $message->id ?>" class="<?= $row_class ?>">
            ...
            <td data-message-id="<?= $message->id ?>" class="inbox-data-date hidden-xs">
                <div><?= substr($message->date_time, 0, 10) ?></div>
            </td>
        </tr>
    <?php endforeach; ?>
    ...
    <!--            <div>-->
    <!--                <span><span class="label bg-color-orange">WORK</span> Karjua Marou</span> New server for datacenter-->
    <!--                needed-->
    <!--            </div>-->
    <!--        </td>-->
    ...
    <!--                   data-original-title="FILES: rocketlaunch.jpg, timelogs.xsl" class="txt-color-darken"><i-->
    ...
    <!--            <div>-->
    <!--                <a href="javascript:void(0);" rel="tooltip" data-placement="left"-->
    <!--                   data-original-title="rocketlaunch.jpg, timelogs.xsl" class="txt-color-darken"><i-->
    <!--                        class="fa fa-paperclip fa-lg"></i></a>-->
    <!--            </div>-->
    <!--        </td>-->
    <!--        <td class="inbox-data-date hidden-xs">-->
    ...
    <!--            <div>-->
    <!--                <a href="javascript:void(0);" rel="tooltip" data-placement="left"-->
    <!--                   data-original-title="payscale-changes.pdf" class="txt-color-darken"><i-->
    <!--                        class="fa fa-paperclip fa-lg"></i></a>-->
    <!--            </div>-->
    <!--        </td>-->
    <!--        <td class="inbox-data-date hidden-xs">-->
...
<script>
    ...
    function getMail($this) {
        ...
        loadURL("email-opened/" + message_id, $('#inbox-content > .table-wrap'));
    }
