<aside id="left-panel">
    ...
    <nav>
        <ul>
            ...
            <li>
                <a href="<?php echo base_url('index.php'); ?>/Parents/view_performance"><i class="fa fa-lg fa-fw fa-bar-chart-o"></i> View Performance</a>
            </li>
            <li>
                <a href="<?php echo base_url('index.php'); ?>/Parents/manage_consultants"><i class="fa fa-lg fa-fw fa-bar-chart-o"></i> Manage Consultants</a>
            </li>
