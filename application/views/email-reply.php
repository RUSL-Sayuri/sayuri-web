...
<form enctype="multipart/form-data" action="<?php echo base_url('email/send'); ?>" method="POST" class="form-horizontal">
		...
		<div id="emailbody">
			...
			<div class="email-reply-text">
				...
				<div>
					...
					<br>	
					<img src="<?php echo base_url('assests/') ?>/img/logo-blacknwhite.png" height="20" width="auto" style="margin-top:7px; padding-right:9px; border-right:1px dotted #9B9B9B;">
