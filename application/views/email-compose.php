...
<form enctype="multipart/form-data" action="<?php echo base_url('email/send'); ?>" method="POST" class="form-horizontal" id="email-compose-form">
	...
	<div class="inbox-info-bar no-padding">
		<div class="row">
			<div class="form-group">
				...
				<div class="col-md-11">
					<select name="to[]" multiple style="width:100%" class="select2" data-select-search="true">
